...
%         PointBins;
    ...
    methods        
        function this = ywOcTree(varargin)
...
%             validateattributes(pts,{'numeric'},{'real','finite','nonnan','ncols', 3}, mfilename,'PTS')
            ...
            this.BinBoundaries = [0 0 0 1 1 1];
            this.BinDepths = 0;
            this.BinParents(1) = 0;
            this.BinCount = 1;
...
%                 maxEdgeSize = max(binEdgeSize);
                ...
                pts = thisBounds([1 2 3; 1 2 6; 1 5 6; 1 5 3; 4 2 3; 4 2 6; 4 5 6; 4 5 3])';
...
%         end
        ...
        function [objID, dists] = queryNN(this, pts)
            ...
            distanceM = abs(sqrt(dist2(pts',o'))- repmat(r,size(pts,2),1));
